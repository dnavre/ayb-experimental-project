...
{block name=content}
    ...
    <form class="form-horizontal" action="/admin/category_save" method="post">
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="category_name" value="{$cat_info['name']}" required/>
            </div>
        </div>
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Name in Armenian</label>
            <div class="col-sm-5">
                <input type="text" class="form-control" name="category_name_arm" value="{$cat_info['name_arm']}" required/>
            </div>
        </div>
        <div class="form-group">
